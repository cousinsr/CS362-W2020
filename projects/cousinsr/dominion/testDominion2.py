...
player_names = ["Rico", "*Lord Vader", "*Geralt"]

# Get the number of victory cards and curse cards.
numVictoryCards = testUtility.GetNumVictoryCards(player_names)
...
# Define the buying power cost of each card in the game.
supply_order = testUtility.GetSupplyOrder()

# Pick 10 Kingdom cards from box to be in the game's supply.
supply = testUtility.GetGameSupplyKingdomCards(box, 0)
